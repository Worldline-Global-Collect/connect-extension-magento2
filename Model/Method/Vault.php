...
class Vault extends BaseVault
{
    ...
    {
        $this->vaultProvider->refund($payment, $amount);
    ...
    {
        $this->vaultProvider->cancel($payment);
    ...
    {
        $this->vaultProvider->void($payment);
    ...
    {
        $this->vaultProvider->initialize($paymentAction, $stateObject);
