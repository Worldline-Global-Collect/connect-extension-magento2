...
use Worldline\Connect\Sdk\CommunicatorConfigurationFactory;
use Worldline\Connect\Sdk\Domain\ShoppingCartExtensionFactory;
...
class ConfigurationBuilder
{
    ...
    public function build(int $scopeId, $data = []): CommunicatorConfiguration
    {
        ...
        $configuration = $this->communicatorConfigurationFactory->create([
            'authorizationId' => $apiKey,
            'authorizationSecret' => $apiSecret,
