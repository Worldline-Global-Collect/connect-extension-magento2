...
abstract class AbstractAddressBuilder
{
     ...
     */
    public function populateAddress(DataObject $dataObject, OrderAddressInterface $orderAddress): void
    {
        if (!$dataObject instanceof Address) {
    ...
    private function getHouseNumberFromAddress(array $streetLines): array
    {
